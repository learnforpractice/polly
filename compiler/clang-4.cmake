...
if(DEFINED POLLY_COMPILER_CLANG_4_CMAKE)
  return()
else()
  set(POLLY_COMPILER_CLANG_4_CMAKE 1)
endif()
...
find_program(CMAKE_C_COMPILER clang-4.0)
find_program(CMAKE_CXX_COMPILER clang++-4.0)
